...
import ProfileItemTemplate from '../../components/Customers/ProfileItemTemplate';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-5 mb-5">
                    <div className="panel">
                        <div className="flex items-center justify-between mb-5">
                            ...
                            <Link to="/account/accountSettings" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                        </div>
                        <div className="flex flex-col sm:flex-row">
                            ...
                            <div className="flex-1 self-center grid grid-cols-1 sm:grid-cols-2  gap-5">
                                <ProfileItemTemplate title={'Full Name'} info={'Ahmed'}>
                                    <PersonStandingIcon className="shrink-0" />
                                </ProfileItemTemplate>

                                <ProfileItemTemplate title={'Role'} info={'Admin'}>
                                    <IconCoffee className="shrink-0" />
                                </ProfileItemTemplate>

                                <ProfileItemTemplate title={'Location'} info={'syria , Damascus'}>
                                    <IconMapPin className="shrink-0" />
                                </ProfileItemTemplate>
                                <ProfileItemTemplate title={'Phone'} info={'09 *** *** **'}>
                                    <IconPhone className="shrink-0" />
                                </ProfileItemTemplate>
                                <ProfileItemTemplate title={'Email'} info={'ahmed324@gmail.com'}>
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <span className="pl-5">{state.role}</span>
                                </div> */}
                                ...
                                {/* <div className="flex flex-col items-center">
                                    ...
                                    <span className="pl-5">{state.location}</span>
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="flex items-center gap-2 mb-1">
                                        <IconPhone className="shrink-0" />
                                    ...
                                    <span className="pl-5">{state.phone}</span>
                                </div> */}
                                ...
                                {/* <div className="flex flex-col items-center">
                                    ...
                                    <span className="pl-5">{state.email}</span>
                                </div> */}
                                {/* <div>
                        ...
                        {/* <div className="w-full flex flex-row justify-between gap-8">
                            <div className="">
                                <img src="/assets/images/profile-34.jpeg" alt="img" className="w-60 rounded-lg object-cover  mb-5" />
                                <p className="font-semibold text-primary text-xl">{state.name}</p>
                            </div>
                            <div className="flex-1 flex flex-col flex-wrap">
                                <div className="felx flex-col p-1">
                                ...
                                <div>
                                    <button className="flex items-center gap-2">
                                        ...
                                        <span className="text-primary truncate">{state.email}</span>
                                    </button>
                                </div>
                                <div className="flex items-center gap-2">
                                    <IconPhone />
