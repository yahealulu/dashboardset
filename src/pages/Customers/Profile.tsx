                    ...
                    <div className="panel">
                        ...
                        <div className="flex flex-col sm:flex-row">
                            ...
                            <div className="flex-1 self-center grid grid-cols-1 sm:grid-cols-2  gap-5">
                                <ProfileItemTemplate title={'Full Name'} info={state.name}>
                                    <PersonStandingIcon className="shrink-0" />
                                </ProfileItemTemplate>

                                <ProfileItemTemplate title={'Role'} info={state.role}>
                                    <IconCoffee className="shrink-0" />
                                </ProfileItemTemplate>

                                <ProfileItemTemplate title={'Location'} info={state.location}>
                                    <IconMapPin className="shrink-0" />
                                </ProfileItemTemplate>
                                <ProfileItemTemplate title={'Phone'} info={state.phone}>
                                    <IconPhone className="shrink-0" />
                                </ProfileItemTemplate>
                                <ProfileItemTemplate title={'Email'} info={state.email}>
